...
- **His own artifacts.** [Neural Networks: Zero to Hero](https://github.com/karpathy/nn-zero-to-hero), eight lectures running from a hundred-line autograd engine to a working tokenizer; the essays on [his blog](https://karpathy.github.io/); and the shrinking line of repositories from nanoGPT through llm.c and nanochat to microgpt. Chapters 1 and 2.
...
- **1. The Workshop.** Build it yourself: micrograd, makemore, nanoGPT, the tokenizer, and the 200-line endpoint. Start here if you learn by typing.
...
- **6. The LLM OS.** The metaphor at the centre of the talk: the model as the processor, with memory, tools and senses bolted on.
...
**If you are new to this, do not start with chapter 3.** [Start here instead](/foundation/book/karpathys-list?section=sec-0-2) — a reading order, and plain definitions for the terms these entries lean on.
